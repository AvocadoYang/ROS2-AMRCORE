...
bool humanoid_pkg__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("humanoid_pkg.msg._status.Status", full_classname_dest, 31) == 0);
  }
  humanoid_pkg__msg__Status * ros_message = _ros_message;
  {  // robot_name
...
PyObject * humanoid_pkg__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("humanoid_pkg.msg._status");
