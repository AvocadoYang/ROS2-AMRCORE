...
{
  new (message_memory) humanoid_pkg::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<humanoid_pkg::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[2] = {
  {
    ...
    offsetof(humanoid_pkg::msg::Status, robot_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(humanoid_pkg::msg::Status, battery_level),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Status_message_members = {
  "humanoid_pkg::msg",  // message namespace
  "Status",  // message name
  2,  // number of fields
  sizeof(humanoid_pkg::msg::Status),
...
get_message_type_support_handle<humanoid_pkg::msg::Status>()
{
  return &::humanoid_pkg::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, humanoid_pkg, msg, Status)() {
  return &::humanoid_pkg::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
